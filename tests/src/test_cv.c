...
//     int *simplified = CV_SIMPLIFY_HOUGH_LINES(lines, n, 30, &n2);
//     int *clean_lines = CV_REMOVE_DIAGONALS(simplified, n2, &n3);
//     int *intersections = CV_GRID_INTERSECTION(processed, clean_lines, n3, &n4);
//     int *sorted_intersections = CV_SORT_INTERSECTIONS(intersections, n4);
//     int *boxes = CV_GRID_BOXES(sorted_intersections, n4, &n5);
...
int test_s1_cv_gaussian_blur()
{
    ...
    CV_IMAGE_SHOW(blurred, "test_s1_cv_gaussian_blur");
...
int test_s1_cv_sobel()
{
    ...
    CV_IMAGE_SHOW(sobel, "test_s1_cv_sobel");
...
int test_s1_cv_adaptive_threshold()
{
    ...
    CV_IMAGE_SHOW(eroded, "test_cv_adaptative_otsu_dilate_erode");
...
int test_s1_cv_save_boxes()
{
    ...
    for (int i = 0; i < n5; i++)
    {
        ...
        CV_DRAW_RECT(image, x1, y1, rw, rh, 2, CV_RGB(255, 0, 0));
    }

    CV_IMAGE_SHOW(image, "test_s1_cv_save_boxes");
